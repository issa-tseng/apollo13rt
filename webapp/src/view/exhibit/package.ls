...
| \imu => new Graphic( src: 'assets/imu.svg', height: 400, caption_number: 1, caption: 'A cutaway view of the active components of the Inertial Measurement Unit. The cylinders inside the central Stable Unit were an assortment of gyroscopes and accelerometers.' )
