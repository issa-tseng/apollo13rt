...
| \msfn-sites => new Graphic( src: 'assets/msfn-sites.svg', height: 199, down: true, caption_number: 1, caption: 'A reproduction of a map of MSFN sites around the world, including mobile air and sea sites, around the Apollo era.', expandable: true )
| \aot-starchart => new Graphic( src: 'assets/aot-starchart.svg', height: 191, caption_number: 2, caption: 'An example star chart used with the AOT on the LM. The number below each marked star is the number the computer recognizes the star by.', expandable: true )
