...
| \orbits-subtle => new Orbit( r: [ 384402000, 0 ], v: [ 0, 230 ], dv: [ 0, -30 ], t: 1, hlimits: [ -13000000, 400000000 ], caption: { number: 4, text: 'a tiny adjustment near the Moon. Earth is to the left.' }, earth: false )
